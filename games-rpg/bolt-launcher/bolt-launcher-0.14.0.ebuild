...
https://github.com/fmtlib/fmt/archive/123913715afeb8a437e6388b4473fcc4753e1c9a.tar.gz -> fmt-1239137.tar.gz
...
src_unpack() {
	...
	tar -xf "${DISTDIR}/fmt-1239137.tar.gz" -C "${S}/Bolt-${PV}/modules/fmt" --strip-components=1
